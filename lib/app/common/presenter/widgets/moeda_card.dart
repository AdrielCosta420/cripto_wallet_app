...
class MoedaCard extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _MoedaCardState();
}
...
class _MoedaCardState extends State<MoedaCard> {
  ...
  Widget build(BuildContext context) {
    var provider = Provider.of<FavoritasRepository>(context,
                                        listen: false);
    return Card(
                  ...
                  PopupMenuItem(
                    child: ListTile(
                      ...
                      onTap: () {
                        ...
                        provider.remove(widget.moeda);
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(
                                '${widget.moeda.sigla} excluída de favoritas'),
                            ...
                            action: SnackBarAction(
                              ...
                              label: 'DESFAZER',
                              onPressed: () {
                                Moedas moedas = widget.moeda;
                                
                                    provider.save(moedas);
                              },
                            ),
                          ),
                        );
